...
<html>
    ...
    <body>
        <a href="#edit-ata" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-ata" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.ata}" method="PUT">
                ...
                <fieldset class="form">
                    ...
                    <g:field  name="version" value="${this.ata?.nota}"/>
